-- AI Workflow Orchestrator - Hybrid Edition Sample Data
-- Created: 2026-01-30
-- Purpose: Seed database compatible with current hybrid schema

-- Insert accounts first (needed for sessions foreign key)
INSERT OR IGNORE INTO accounts (id, account_name, platform, status) VALUES
  (1, 'Account-01', 'genspark', 'available'),
  (2, 'Account-02', 'claude', 'available');
...
-- Insert sample sessions (need account_id for compatibility)
